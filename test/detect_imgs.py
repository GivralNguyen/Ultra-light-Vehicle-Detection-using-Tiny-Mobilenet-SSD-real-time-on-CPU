...
parser.add_argument('--result_path', default = '/media/ducanh/DATA/tienln/ai_camera/detector/detect_results', help='result path to save')
parser.add_argument('--test_path', default = "/media/ducanh/DATA/tienln/data/test_data/fisheye", help='path of folder test')
