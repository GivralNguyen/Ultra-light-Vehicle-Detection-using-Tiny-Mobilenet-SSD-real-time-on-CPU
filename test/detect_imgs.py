...
if __name__ == "__main__":
    ...
    for image_path in listdir:
        ...
        boxes, labels, probs = predictor.predict(new_image, 2000,0.7)
        ...
        for i in range(boxes.size(0)):
            ...
            if labels[i] == 1:
                ...
                class_name = 'truck'       
            cv2.putText(new_image, str(labels[i]), (int(box[0]-30), int(box[1]-10)),cv2.FONT_HERSHEY_DUPLEX, 0.3, (255, 255, 255))
